  ...
  return (
    <AppShell variant="admin" crumb={<>Admin · <b>Pengaturan</b></>} contentClassName="narrow">
        ...
        <div className="card">
          ...
          <div className="card-pad">
            <div className="field">
              ...
              <input className="input" id="site-name" type="text" defaultValue="Kimia Pintar" />
            </div>
            <div className="field">
              <label htmlFor="domain">Domain</label>
              <input className="input" id="domain" type="text" defaultValue="kimiapintar.com" />
            </div>
            <div className="field" style={{ marginBottom: 0 }}>
              <label htmlFor="lang">Bahasa</label>
              <select className="select" id="lang" defaultValue="Bahasa Indonesia">
        ...
        <div className="card">
          ...
          <div className="card-pad" style={{ paddingTop: "6px" }}>
            ...
            <div className="set-row">
              ...
              <label className="switch"><input type="checkbox" /><span className="track"></span></label>
            </div>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className="card-pad">
            <div className="field">
              ...
              <input className="input" id="passing" type="number" defaultValue="60" min="0" max="100" />
            ...
            <div className="field">
              ...
              <select className="select" id="grade-method" defaultValue="highest">
            ...
            <div className="field">
              ...
              <select className="select" id="show-answers" defaultValue="after_submit">
      ...
      <div className="save-bar">
        ...
        <button className="btn btn-primary" type="button"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"><path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z" /><path d="M17 21v-8H7v8M7 3v5h8" /></svg>Simpan pengaturan</button>
      </div>
    </AppShell>
  );
}
